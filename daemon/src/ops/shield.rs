        ...
        match mode.to_lowercase().as_str() {
            "strict" => {
                ...
                let _ = Command::new("sysctl")
                    ...
                    .output();
                let _ = Command::new("sysctl")
                    .args(["-w", "net.ipv4.tcp_max_syn_backlog=65536"])
                    .output();
                let _ = Command::new("sysctl")
                    .args(["-w", "net.ipv4.tcp_synack_retries=1"])
                    .output();
                let _ = Command::new("sysctl")
                    .args(["-w", "net.ipv4.tcp_fin_timeout=15"])
                    .output();
                let _ = Command::new("sysctl")
                    .args(["-w", "net.netfilter.nf_conntrack_max=2097152"])
                    .output();
            ...
            "off" => {
                ...
                let _ = Command::new("sysctl")
                    .args(["-w", "net.ipv4.tcp_syncookies=0"])
                    .output();
            }
            _ => {
                // Standard mode
                ...
                let _ = Command::new("sysctl")
                    ...
                    .output();
                let _ = Command::new("sysctl")
                    .args(["-w", "net.ipv4.tcp_max_syn_backlog=8192"])
                    .output();
                let _ = Command::new("sysctl")
                    .args(["-w", "net.ipv4.tcp_synack_retries=2"])
                    .output();
                let _ = Command::new("sysctl")
                    .args(["-w", "net.ipv4.tcp_fin_timeout=30"])
                    .output();
